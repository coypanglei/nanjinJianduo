...
import com.shaoyue.weizhegou.module.credit.fragment.apply.DYFaceRecognitionFragment;
import com.shaoyue.weizhegou.router.UIHelper;

import org.greenrobot.eventbus.EventBus;

public class DyFaceActivity extends BaseCommonActivity {

    private String mContentType;

    public static Intent newInstance(Context context, String contentType) {
        Intent intent = new Intent(context, DyFaceActivity.class);
    ...
    protected BaseFragment getFirstFragment() {
        return DYFaceRecognitionFragment.newInstance(mContentType);
    }
