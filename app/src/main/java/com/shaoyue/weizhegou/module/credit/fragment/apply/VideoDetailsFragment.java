...
public class VideoDetailsFragment extends BaseAppFragment {
    ...
    public static VideoDetailsFragment newInstance(String title) {
    ...
    public void onMessageEvent(final OcrBean ocrBean) {
        ...
        if (title.equals("担保抵押")) {
            if (mTitle.contains("抵押") || mTitle.contains("保证")) {
                addPic(ocrBean);
            }
            return;
        }
    ...
    public void onMessageEvent(final VideoMaterialBean.ListBean listBean) {
        ...
        if (id.equals(listBean.getId())) {
            ...
            for (VideoMaterialBean bean : mAdapter.getData()) {
                ...
                if (title.equals("担保抵押")) {
                    if (bean.getTitle().contains("保证") || bean.getTitle().contains("抵押")) {
