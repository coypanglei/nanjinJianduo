...
import com.shaoyue.weizhegou.module.sxdc.adapter.SyjbInformationAdapter;
...
public class DcSyjbFragment extends BaseAppFragment {
    @BindView(R.id.ry_info)
    RecyclerView mIdJiben1;
    SyjbInformationAdapter mAdapter;
    ...
    public static DcSyjbFragment newInstance() {

        Bundle args = new Bundle();
        DcSyjbFragment fragment = new DcSyjbFragment();
                                ...
                                if ("收入".equals(title.getTitle())) {
                                    ...
                                    if ("本期(万元)".equals(bean.getTitile())) {
                                        ...
                                        if (ObjectUtils.isNotEmpty(bean.getDefaultvalue())) {
                                            ...
                                            if ("主营业务收入".equals(bean1.getTitile())) {
                                                qnzysr = Double.valueOf(bean.getDefaultvalue());
                                            }
                                        ...
                                        if (ObjectUtils.isNotEmpty(bean.getDefaultvalue())) {
                                            ...
                                            if ("主营业务收入".equals(bean1.getTitile())) {
                                                jnzysr = Double.valueOf(bean.getDefaultvalue());
                                            }

                                            jnzsr = jnzsr + Double.valueOf(bean.getDefaultvalue());
                                        }
                                    }
                                } else if ("支出".equals(title.getTitle())) {
                                    if ("本期(万元)".equals(bean.getTitile())) {
                                        ...
                                        if (ObjectUtils.isNotEmpty(bean.getDefaultvalue())) {
                                            ...
                                            if ("主营业务支出".equals(bean1.getTitile())) {
                                                jnzyzc = Double.valueOf(bean.getDefaultvalue());
                                            }

                                            jnzzc = jnzzc + Double.valueOf(bean.getDefaultvalue());
                                        }
                                    }
                                }
...
//                }
        ...
        for (BasicTitle title : list) {
            if ("数据统计".equals(title.getTitle())) {
                ...
                title.getMlist().get(0).getList().get(2).setDefaultvalue(String.format("%.2f", jnzsr));
                //总收入
                ...
                title.getMlist().get(1).getList().get(2).setDefaultvalue(String.format("%.2f", jnzzc));

                //主营净利润
                title.getMlist().get(2).getList().get(0).setDefaultvalue(String.format("%.2f", (zysr - zyzc)));
                title.getMlist().get(2).getList().get(1).setDefaultvalue(String.format("%.2f", (qnzysr - qnzyzc)));
                title.getMlist().get(2).getList().get(2).setDefaultvalue(String.format("%.2f", (jnzysr - jnzyzc)));
                //净利润
                title.getMlist().get(3).getList().get(0).setDefaultvalue(String.format("%.2f", (zsr - zzc)));
                title.getMlist().get(3).getList().get(1).setDefaultvalue(String.format("%.2f", (qnzsr - qnzzc)));
                title.getMlist().get(3).getList().get(2).setDefaultvalue(String.format("%.2f", (jnzsr - jnzzc)));
                //月度平均净利润
                title.getMlist().get(4).getList().get(0).setDefaultvalue(String.format("%.2f", (zsr - zzc) / 12));
                title.getMlist().get(4).getList().get(1).setDefaultvalue(String.format("%.2f", (qnzsr - qnzzc) / 12));
                title.getMlist().get(4).getList().get(2).setDefaultvalue(String.format("%.2f", (jnzsr - jnzzc) / 12));
                //家庭净收入
                title.getMlist().get(5).getList().get(0).setDefaultvalue(String.format("%.2f", (zsr - zzc)));
                title.getMlist().get(5).getList().get(1).setDefaultvalue(String.format("%.2f", (qnzsr - qnzzc)));
                title.getMlist().get(5).getList().get(2).setDefaultvalue(String.format("%.2f", (jnzsr - jnzzc)));
            }
        }
    ...
    protected void initView(View rootView) {
        ...
        initDatePicker();
        titles.add(new BasicTitle("收入", new ArrayList<BasicInformationBean.RecordsBean>()));
        titles.add(new BasicTitle("支出", new ArrayList<BasicInformationBean.RecordsBean>()));
        titles.add(new BasicTitle("主营业务收入检验", new ArrayList<BasicInformationBean.RecordsBean>()));
        titles.add(new BasicTitle("年净利润检验", new ArrayList<BasicInformationBean.RecordsBean>()));
        ...
        mAdapter = new SyjbInformationAdapter();
    ...
    private void initview() {
        CeditApi.getListAll("损益简表", null, new BaseCallback<BaseResponse<BasicInformationBean>>() {
            @Override
            public void onSucc(BaseResponse<BasicInformationBean> result) {
                ...
                for (BasicTitle title : titles) {
                    if ("收入".equals(title.getTitle()) || "支出".equals(title.getTitle())) {
...
//                                    }
                    ...
                    map.put("id", id);
                    DcApi.editSyjbINfo(map, new BaseCallback<BaseResponse<Void>>() {
                        @Override
