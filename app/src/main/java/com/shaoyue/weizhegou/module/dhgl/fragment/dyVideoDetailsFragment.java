...
public class dyVideoDetailsFragment extends BaseAppFragment {
    ...
    public static dyVideoDetailsFragment newInstance(String title) {
        Bundle args = new Bundle();
        args.putString("title", title);
        dyVideoDetailsFragment fragment = new dyVideoDetailsFragment();
