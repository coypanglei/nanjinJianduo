...
public class DbyxziFragment extends BaseTitleFragment {
    ...
    public static DbyxziFragment newInstance(String title) {
        Bundle args = new Bundle();
        args.putString("title", title);
        DbyxziFragment fragment = new DbyxziFragment();
    ...
    protected void initView(View rootView) {
        ...
        setCommonTitle("担保影像资料");
        mAdapter = new VideoListDhAdapter(getActivity(), 1);
                ...
                Luban.with(getActivity())
                        ...
                        .setCompressListener(new OnCompressListener() {
                            ...
                            public void onSuccess(final File file) {
                                final String zllx = SPUtils.getInstance().getString("selectPic_zllx");
//                                //上传头像
                                ...
                                UserApi.updatePic(file, new BaseCallback<BaseResponse<String>>() {
                                    ...
                                    public void onSucc(BaseResponse<String> result) {
                                        ...
                                        CeditApi.addVideo(title, mdata, new BaseCallback<BaseResponse<Void>>() {
                                            @Override
...
//                }
            ...
            videoMaterialBean.setUrl("DBRYXZL");
     ...
     */
    private void resh() {
        CeditApi.getSdVideoDetailsList(title, new BaseCallback<BaseResponse<VideoBean>>() {
            @Override
