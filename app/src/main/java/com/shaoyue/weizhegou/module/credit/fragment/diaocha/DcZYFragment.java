...
public class DcZYFragment extends BaseAppFragment {
    ...
    public static DcZYFragment newInstance() {

        Bundle args = new Bundle();
        DcZYFragment fragment = new DcZYFragment();
...
//        LogUtils.e(type);
        titles.add(new BasicTitle("种植户", new ArrayList<BasicInformationBean.RecordsBean>()));
        titles.add(new BasicTitle("养殖户", new ArrayList<BasicInformationBean.RecordsBean>()));
    ...
    private void initview() {
        CeditApi.getListAll("农户种植养殖", null, new BaseCallback<BaseResponse<BasicInformationBean>>() {
            @Override
    ...
    private void getListById() {
        DcApi.getzzinfo(new BaseCallback<BaseResponse<JsonObject>>() {
            @Override
...
//
        ...
        switch (view.getId()) {
            ...
            case R.id.sb_edit:
                ...
                if (ObjectUtils.isNotEmpty(id)) {
                    ...
                    map.put("id", id);
                    DcApi.editzzINfo(map, new BaseCallback<BaseResponse<Void>>() {
                        @Override
    ...
    private void firstAdd() {
        ...
        DcApi.addzzInfo(map, new BaseCallback<BaseResponse<Void>>() {
            @Override
            public void onSucc(BaseResponse<Void> result) {
                ToastUtil.showBlackToastSucess("保存成功");
                getListById();
