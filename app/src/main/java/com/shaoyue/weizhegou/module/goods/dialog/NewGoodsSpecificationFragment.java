...
public class NewGoodsSpecificationFragment extends DialogFragment implements DialogInterface.OnKeyListener {
    ...
    public static NewGoodsSpecificationFragment newInstance(GoodsDetialBean goodsDetialBean) {
        Bundle args = new Bundle();
        args.putSerializable("goodsDetialBean", goodsDetialBean);
        NewGoodsSpecificationFragment fragment = new NewGoodsSpecificationFragment();
...
//                    return;
//                }
                final String mItemId = id;
                final String productNum = "1";
                GoodsApi.carConfirm("", "", "", mGoodsBetialBean.getProducts_id(), mItemId, productNum, "buy_now", "0", new BaseCallback<BaseResponse<SettlementCenterBean>>() {
                    @Override
                    public void onSucc(BaseResponse<SettlementCenterBean> result) {
                        ...
                        mSettlementCenterBean.setItem_id(mItemId);
                        mSettlementCenterBean.setProducts_num(productNum);
                        mSettlementCenterBean.setAction("buy_now");
