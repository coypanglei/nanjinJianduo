...
public class XcjyFamilyInfoFragment extends BaseAppFragment implements BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    public static XcjyFamilyInfoFragment newInstance(String title) {

        Bundle args = new Bundle();
        args.putString("title", title);
        XcjyFamilyInfoFragment fragment = new XcjyFamilyInfoFragment();
