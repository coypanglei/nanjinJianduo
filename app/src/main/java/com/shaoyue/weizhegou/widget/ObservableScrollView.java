...
public class ObservableScrollView extends ScrollView {
    ...
    public interface OnObservableScrollViewListener {
        ...
        void onObservableScrollBottom(boolean bottom);
    }
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        if (mOnObservableScrollViewListener != null) {
            ...
            if (getScrollY() == 0) {
                mOnObservableScrollViewListener.onObservableScrollBottom(false);
            } else if (getScrollY() + getHeight() - getPaddingTop() - getPaddingBottom() == getChildAt(0).getHeight()) {
                mOnObservableScrollViewListener.onObservableScrollBottom(true);
            } else {
                mOnObservableScrollViewListener.onObservableScrollBottom(false);
            }
        }
