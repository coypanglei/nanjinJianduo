package com.shaoyue.weizhegou.widget.gesture;
...
public class GestureLockDisplayView extends View {
    ...
    //选中颜色
    private int mDotSelectedColor = Color.parseColor("#20a3f5");
    //未选中时颜色
    private int mDotUnSelectedColor = Color.parseColor("#c7cdd9");
    ...
    private void init(Context context) {
        ...
        mPaint.setColor(Color.parseColor("#c7cdd9"));
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mDotMargin = (int) (0.5 * mCircleRadius);
