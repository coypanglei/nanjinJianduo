...
import com.shaoyue.weizhegou.util.SizeTool;
import com.shaoyue.weizhegou.util.StringTool;
...
//        }
        ...
        if (canSelect) {
            this.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.icon_bottom_go, 0);
        }
