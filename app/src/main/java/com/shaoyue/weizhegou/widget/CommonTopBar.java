...
public class CommonTopBar extends FrameLayout {
    ...
    private FrameLayout mLayLeft;
    private FrameLayout mLayCenter;
    private FrameLayout mLayRight;
    ...
    public CommonTopBar(Context context, AttributeSet attrs, int defStyleAttr) {
         ...
         * 获得我们所定义的自定义样式属性
         */
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.shaoyue.weizhegou.R.styleable.TitleBar, defStyleAttr, com.shaoyue.weizhegou.R.style.TitleBarDefaultStyle);
        int n = a.getIndexCount();
        for (int i = 0; i < n; i++) {
            int attr = a.getIndex(i);
            switch (attr) {
                case com.shaoyue.weizhegou.R.styleable.TitleBar_TextLeft:
//                    mTextLeft = a.getString(attr);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_TextCenter:
                    mTextCenter = a.getString(attr);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_TextRight:
                    mTextRight = a.getString(attr);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_TextColorLeft:
                    mTextColorLeft = a.getColor(attr, Color.BLACK);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_TextColorCenter:
                    mTextColorCenter = a.getColor(attr, Color.BLACK);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_TextColorRight:
                    mTextColorRight = a.getColor(attr, Color.BLACK);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_TextSizeLeft:
                    mTextSizeLeft = a.getDimensionPixelSize(attr, 12);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_TextSizeCenter:
                    mTextSizeCenter = a.getDimensionPixelSize(attr, 17);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_TextSizeRight:
                    mTextSizeRight = a.getDimensionPixelSize(attr, 12);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_isShowImgLeft:
                    isShowImgLeft = a.getBoolean(attr, true);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_isShowImgRight:
                    isShowImgRight = a.getBoolean(attr, true);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_isShowLeft:
                    isShowLeft = a.getBoolean(attr, true);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_isShowRight:
                    isShowRight = a.getBoolean(attr, false);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_srcLeft:
                    mDrawLeft = a.getDrawable(attr);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_srcRight:
                    mDrawRight = a.getDrawable(attr);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_bg:
                    mDrawBg = a.getDrawable(attr);
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_onClickLeft:
                    ...
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_onClickCenter:
                    if (context.isRestricted()) {
                    ...
                    break;
                case com.shaoyue.weizhegou.R.styleable.TitleBar_onClickRight:
...
//        setTextSizeLeft(mTextSizeLeft);
    ...
    public void init(Context c) {
        this.mContext = c;
        LayoutInflater.from(mContext).inflate(com.shaoyue.weizhegou.R.layout.layout_topbar, this, true);
        mTxtLeft = (TextView) findViewById(com.shaoyue.weizhegou.R.id.tv_title_left);
        mTxtCenter = (TextView) findViewById(com.shaoyue.weizhegou.R.id.tv_title_center);
        mTxtRight = (TextView) findViewById(com.shaoyue.weizhegou.R.id.tv_title_right);
        mLayLeft = (FrameLayout) findViewById(com.shaoyue.weizhegou.R.id.fl_title_left);
        mLayCenter = (FrameLayout) findViewById(com.shaoyue.weizhegou.R.id.fl_title_center);
        mLayRight = (FrameLayout) findViewById(com.shaoyue.weizhegou.R.id.fl_title_right);
        mImgBg = (ImageView) findViewById(com.shaoyue.weizhegou.R.id.iv_title_bg);
        mImgLeft = (ImageView) findViewById(com.shaoyue.weizhegou.R.id.iv_title_left);
        mImgRight = (ImageView) findViewById(com.shaoyue.weizhegou.R.id.iv_title_right);
    ...
    private void setShowImgRight() {
        mLayRight.setVisibility(VISIBLE);
        if (isShowImgRight) {
